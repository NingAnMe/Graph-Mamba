...
class PBFSSuperpixels(InMemoryDataset):
    ...
    url = 'https://www.dropbox.com/s/8x722ai272wqwl4/voc_superpixels_edge_wt_region_boundary.zip?dl=1'

    def __init__(self, root, name='pbfs-function', split='train',
                 transform=None, pre_transform=None, pre_filter=None):
        self.name = name
        assert split in ['train', 'val', 'test']
        assert name in ['edge_wt_region_boundary']
